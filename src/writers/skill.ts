...
import { DesignProfile, ComponentInfo, ComponentCategory, ColorToken } from '../types';
...
function generateColorSystem(
  profile: DesignProfile,
  bg: ColorToken | undefined, surface: ColorToken | undefined, accent: ColorToken | undefined, textPrimary: ColorToken | undefined, textMuted: ColorToken | undefined,
  border: ColorToken | undefined, danger: ColorToken | undefined, success: ColorToken | undefined, warning: ColorToken | undefined
): string {
  let s = '';
...
function generateComponentPatterns(
  profile: DesignProfile,
  bg: ColorToken | undefined, surface: ColorToken | undefined, accent: ColorToken | undefined, textPrimary: ColorToken | undefined, textMuted: ColorToken | undefined,
  border: ColorToken | undefined, commonRadius: string
): string {
  let s = '';
  const sp = profile.spacing;
  ...
  const col = (token: ColorToken | undefined, role?: string): string => {
...
function generateElevationSection(
  profile: DesignProfile,
  traits: DesignProfile['designTraits'],
  surface: ColorToken | undefined,
  bg: ColorToken | undefined
): string {
  let s = '';
...
function generateQuickReference(
  profile: DesignProfile,
  bg: ColorToken | undefined, surface: ColorToken | undefined, accent: ColorToken | undefined, textPrimary: ColorToken | undefined, textMuted: ColorToken | undefined,
  border: ColorToken | undefined, primaryFont: string, commonRadius: string
): string {
  let s = '';
