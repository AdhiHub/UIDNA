...
export interface DesignProfile {
  ...
  cssFrameworksDetected: CSSFramework[];
  a11y: A11yAudit;
...
export interface A11yIssue {
  type: 'contrast' | 'aria' | 'focus' | 'semantics' | 'color';
...
export interface A11yAudit {
  score: number;
  issues: A11yIssue[];
  contrastRatios: Array<{ foreground: string; background: string; ratio: number; passesAA: boolean; passesAAA: boolean }>;
